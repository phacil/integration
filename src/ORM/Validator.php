...
class Validator {
    ...
    protected static $errorsFolder = null;
    ...
    protected function getDefaultErrorTexts($lang = null) {
        ...
        if (file_exists(self::$errorsFolder . $lang . ".php")) {
            $default_error_texts = include(self::$errorsFolder . $lang . ".php");
        }
    ...
    public function getErrors($lang = null) {
        ...
        foreach ($this->errors as $input_name => $results) {
            foreach ($results as $rule => $result) {
                ...
                $error_results[$named_input] = str_replace(":attribute", $named_input, $error_message);
            }
        }
    ...
    public static function setErrorsFolderValidate($folder = null){
        self::$errorsFolder = $folder;
    }
}
